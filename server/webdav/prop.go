...
var liveProps = map[xml.Name]struct {
	...
	findFn func(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error)
...
func props(ctx context.Context, ls LockSystem, fi FileInfo, pnames []xml.Name) ([]Propstat, error) {
	isDir := fi.IsDir()
...
func propnames(ctx context.Context, ls LockSystem, fi FileInfo) ([]xml.Name, error) {
	isDir := fi.IsDir()
...
func allprop(ctx context.Context, ls LockSystem, fi FileInfo, include []xml.Name) ([]Propstat, error) {
...
func findResourceType(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	if fi.IsDir() {
...
func findDisplayName(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	if slashClean(name) == "/" {
		return "", nil
	}
...
func findContentLength(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	return strconv.FormatInt(fi.GetSize(), 10), nil
}

func findLastModified(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	return fi.ModTime().UTC().Format(http.TimeFormat), nil
}

func findCreationDate(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
...
func findContentType(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
...
func findETag(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	etag := fi.GetETag()
	if etag != "" {
...
func findSupportedLock(ctx context.Context, ls LockSystem, name string, fi FileInfo) (string, error) {
	return `` +
